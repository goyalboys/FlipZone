    ...
    <div class="filter-row">
            ...
            <div class="column-filter">
                ...
                <h2 style="text-align:center;">Filters</h2>
                    ...
                    <input type="checkbox" name={{$company}}>{{$company}}<br>
                    @endforeach
                    <hr>
                    <b>Rating:</b>
                    <br>
                    <input type="radio" name=""> 4⭐& above<br>
                    <input type="radio" name=""> 3⭐& above<br>
                    <input type="radio" name=""> 2⭐& above<br>
                    <input type="radio" name=""> 1⭐& above<br>
                    <br>
                    <hr>
                    <b>Offer:</b>
                    <br>
                    @foreach($offers as $offer)
                    <input type="checkbox" name={{$offer}}>{{$offer}}<br>
                    @endforeach
                    <hr>
                    <b>size:</b><br>
                    ...
                    <input type="radio" name={{$discount}}>{{$discount}} & above<br>
                    @endforeach
                    <br>
                </div>
            </div>
